# Developer Agreement Type pages
...
These pages are [updated nightly](https://github.com/digital-land/developer-agreement-type/actions) by the [GitHub Action](.github/workflows/run.yml).
